...
en @rosen-number-th[p. 3], ese adjetivo se refiere a que no se apoyará en
...
$(-a)(-b) = a b$ para $a, b in bb(Z)$, que se admiten como ciertas porque
usted ya las conoce (aunque quizás no sepa demostrarlas). No es el propósito
de esta asignatura demostrar afirmaciones sobre las estructuras algebraicas
numéricas que se usan (principalmente, $(bb(Z), +, dot.op)$), sino que nos
dedicaremos a estudiar otros aspectos de los números enteros
(principalmente), como la divisibilidad, los números primos, ecuaciones
diofánticas, etc.
...
demostración de que $bb(Q)$ es numerable en el Teorema 1.4 de
@rosen-number-th[p. 11]. En cualquier caso, los racionales casi no
aparecerán.
...
aplicación práctica#footnote[cosa de la que se jactaba el gran matemático
G.~H.~Hardy, que era un pacifista y odiaría enterarse de que la teoría que
él mismo estaba contribuyendo a desarrollar se usaría con fines bélicos],
con la llegada de los computadores los matemáticos se dieron cuenta de que
se podía aplicar a la criptografía, y actualmente es una parte fundamental
de esta. En cualquier caso, por razones de tiempo, en esta asignatura apenas
se dedicará tiempo a las aplicaciones prácticas de la teoría de números.
...
/*
* Notación factorial. Se podría usar una function-call expression, pero se
* usa el símbolo !. Si no se pone paréntesis, afecta a una única variable;
* la que tiene a su izquierda.
* */
