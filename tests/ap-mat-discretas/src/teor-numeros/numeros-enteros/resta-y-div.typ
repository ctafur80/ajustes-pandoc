...
realidad una consecuencia de la suma en $bb(Z)$.

#block[
  Dados $a, b in bb(Z)$. La operación $a$ menos $b$, que simbólicamente
  denotamos como $a - b$, es el número $d in bb(Z)$ con el que se cumple $a
  = b + d$.
] <def-op-resta>
...
la división que usaba en la educación primaria, la división en $bb(Z)$ con
resto, operación que definiremos en el capítulo sobre la división entera.
