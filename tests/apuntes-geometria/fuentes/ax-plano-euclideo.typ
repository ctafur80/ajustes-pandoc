...
Teorema --- "de las Posiciones Relativas de Dos Rectas".
...
#proof[
  ...
  #[ #set align(center)
    ...
    inset: 3pt,
      [$p$:], [$r$ y $s$ no tienen ningún punto en común. Es decir, $r
      "inter"
        s = emptyset$],
...
Axioma "P3 de Euclides (de la Regla Graduada)"
...
Teorema "Ampliación del Punto (3) del Axioma $bold(P)$4"
...
Teorema "de Conservaciones de Figuras por Isometrías"
...
Teorema "de la Conservación del Punto Medio de un Segmento por Isometría")[
...
Teorema "de la Isometría de Dos Rectas Secantes")[
...
Teorema "de las Isometrías de Semirrectas")[
